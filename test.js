;(function ($) {
  ...
  $.fn.datepicker2 = function (o) {
    ...
    var def = {
      ...
      monthName: [
        i18n.datepicker.dateformat.jan,
        i18n.datepicker.dateformat.feb,
        i18n.datepicker.dateformat.mar,
        i18n.datepicker.dateformat.apr,
        i18n.datepicker.dateformat.may,
        i18n.datepicker.dateformat.jun,
        i18n.datepicker.dateformat.jul,
        i18n.datepicker.dateformat.aug,
        i18n.datepicker.dateformat.sep,
        i18n.datepicker.dateformat.oct,
        i18n.datepicker.dateformat.nov,
        i18n.datepicker.dateformat.dec
      ],
    ...
    if (cp.length == 0) {
      ...
      cpHA.push(
        "<table class='bbit-dp-top' cellspacing='0'><tr><td class='bbit-dp-top-left'><a id='BBIT_DP_LEFTBTN' href='javascript:void(0);' title='",
        i18n.datepicker.prev_month_title,
        "'>&nbsp;</a></td><td class='bbit-dp-top-center' align='center'><em><button id='BBIT_DP_YMBTN'></button></em></td><td class='bbit-dp-top-right'><a id='BBIT_DP_RIGHTBTN' href='javascript:void(0);' title='",
        i18n.datepicker.next_month_title,
        "'>&nbsp;</a></td></tr></table>"
      )
      cpHA.push('</td></tr>')
      cpHA.push('<tr><td>')
      ...
      cpHA.push(
        "<td class='bbit-dp-mp-ybtn' align='middle'><a id='BBIT-DP-MP-PREV' class='bbit-dp-mp-prev'></a></td><td class='bbit-dp-mp-ybtn bbit-dp-mp-sep' align='middle'><a id='BBIT-DP-MP-NEXT' class='bbit-dp-mp-next'></a></td><td class='bbit-dp-mp-month' xmonth='0'><a href='javascript:void(0);'>",
        def.monthName[0],
        '<span>' + def.monthp + "</span></a></td><td class='bbit-dp-mp-month' xmonth='6'><a href='javascript:void(0);'>",
        def.monthName[6],
        '<span>' + def.monthp + '</span></a></td>'
      )
      cpHA.push('</tr>')
      cpHA.push('<tr>')
      cpHA.push(
        "<td class='bbit-dp-mp-year'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-year bbit-dp-mp-sep'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-month' xmonth='1'><a href='javascript:void(0);'>",
        def.monthName[1],
        '<span>' + def.monthp + "</span></a></td><td class='bbit-dp-mp-month' xmonth='7'><a href='javascript:void(0);'>",
        def.monthName[7],
        '<span>' + def.monthp + '</span></a></td>'
      )
      cpHA.push('</tr>')
      cpHA.push('<tr>')
      cpHA.push(
        "<td class='bbit-dp-mp-year'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-year bbit-dp-mp-sep'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-month' xmonth='2'><a href='javascript:void(0);'>",
        def.monthName[2],
        '<span>' + def.monthp + "</span></a></td><td class='bbit-dp-mp-month' xmonth='8'><a href='javascript:void(0);'>",
        def.monthName[8],
        '<span>' + def.monthp + '</span></a></td>'
      )
      cpHA.push('</tr>')
      cpHA.push('<tr>')
      cpHA.push(
        "<td class='bbit-dp-mp-year'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-year bbit-dp-mp-sep'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-month' xmonth='3'><a href='javascript:void(0);'>",
        def.monthName[3],
        '<span>' + def.monthp + "</span></a></td><td class='bbit-dp-mp-month' xmonth='9'><a href='javascript:void(0);'>",
        def.monthName[9],
        '<span>' + def.monthp + '</span></a></td>'
      )
      cpHA.push('</tr>')
      ...
      cpHA.push('<tr>')
      cpHA.push(
        "<td class='bbit-dp-mp-year'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-year bbit-dp-mp-sep'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-month' xmonth='4'><a href='javascript:void(0);'>",
        def.monthName[4],
        '<span>' + def.monthp + "</span></a></td><td class='bbit-dp-mp-month' xmonth='10'><a href='javascript:void(0);'>",
        def.monthName[10],
        '<span>' + def.monthp + '</span></a></td>'
      )
      cpHA.push('</tr>')
      ...
      cpHA.push('<tr>')
      cpHA.push(
        "<td class='bbit-dp-mp-year'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-year bbit-dp-mp-sep'><a href='javascript:void(0);'></a></td><td class='bbit-dp-mp-month' xmonth='5'><a href='javascript:void(0);'>",
        def.monthName[5],
        '<span>' + def.monthp + "</span></a></td><td class='bbit-dp-mp-month' xmonth='11'><a href='javascript:void(0);'>",
        def.monthName[11],
        '<span>' + def.monthp + '</span></a></td>'
      )
      cpHA.push('</tr>')
    ...
    function rryear(y) {
      ...
      $('#BBIT-DP-MP td.bbit-dp-mp-year').each(function (i) {
        ...
        $(this)
          .html("<a href='javascript:void(0);'>" + ar[i] + '</a>')
          .attr('xyear', ar[i])
      })
    }
    ...
    function returndate() {
      ...
      if (re && jQuery.isFunction(re)) {
        ...
        if (ym) ct.val(dateFormat.call(new Date(def.Year, def.Month - 1), 'yyyy-MM'))
        else if (ct) ct.val(dateFormat.call(cp.data('indata'), i18n.datepicker.dateformat.fulldayvalue))
      }

      ck.attr('isshow', '0')
      cp.removeData('ctarget').removeData('cpk').removeData('indata').removeData('onReturn').removeData('ymonly').removeData('ads').removeData('ade')
      cp.css('visibility', 'hidden')
      ct = ck = null
      clearevents()
    }
